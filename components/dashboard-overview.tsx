...
const stats = [
  ...
  },
  {
    ...
    value: initialInvitations.filter(i => i.status === "sent" || i.status === "pending").length.toString(),
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Overview of your officer management system</p>
      </div>
        ...
        <Card className="border-border/50 bg-card">
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-card-foreground">Weekly Attendance</CardTitle>
            ...
            <div className="h-[260px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={weeklyAttendance} barGap={4}>
                  ...
                  />
                  <Bar dataKey="present" fill="oklch(0.68 0.17 150)" radius={[4, 4, 0, 0]} name="Present" />
                  <Bar dataKey="absent" fill="oklch(0.577 0.245 27.325)" radius={[4, 4, 0, 0]} name="Absent" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
              ...
              <div className="flex flex-col gap-2">
                {departmentData.map((dept, index) => (
                  <div key={dept.name} className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-card-foreground ml-auto">{dept.value}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <CardContent>
          <div className="flex flex-col gap-3">
            {[
              ...
              { action: "Annual Training Conference invitation sent", time: "Yesterday", type: "invitation" },
