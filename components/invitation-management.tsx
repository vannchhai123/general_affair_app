    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Create and manage event invitations for officers
          </p>
        </div>
            ...
            <div className="flex flex-col gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    type="number"
                    value={form.invitedOfficers}
                    onChange={(e) => setForm({ ...form, invitedOfficers: Number(e.target.value) })}
                    className="bg-input border-border text-foreground"
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <Select
                    value={form.status}
                    onValueChange={(v) => setForm({ ...form, status: v as Invitation['status'] })}
                  >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
        {[
          ...
          {
            label: 'Sent',
            value: invitations.filter((i) => i.status === 'sent').length,
            color: 'text-primary',
          },
          {
            label: 'Completed',
                  ...
                  <TableCell>
                    <div className="flex flex-col gap-1">
                      <span className="text-xs text-muted-foreground">
                        {inv.confirmedOfficers}/{inv.invitedOfficers}
                      </span>
                      <Progress
                        value={
                          inv.invitedOfficers > 0
                            ? (inv.confirmedOfficers / inv.invitedOfficers) * 100
                            : 0
                        }
                    ...
                    <div className="flex items-center justify-end gap-1">
                      ...
                      {inv.status === 'pending' && (
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleSendInvitation(inv.id)}
            ...
            <div className="flex flex-col gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-sm text-card-foreground">
                    {selectedInvitation.invitedOfficers}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-muted-foreground">Confirmed</span>
                  <span className="text-sm text-card-foreground">
                    {selectedInvitation.confirmedOfficers}
                  </span>
                </div>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <Badge
                  variant="outline"
                  className={`w-fit ${statusColor(selectedInvitation.status)}`}
                >
