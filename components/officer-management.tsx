...
export function OfficerManagement() {
  ...
  function handleSave() {
    ...
    if (editingOfficer) {
      setOfficers((prev) => prev.map((o) => (o.id === editingOfficer.id ? { ...o, ...form } : o)));
          ...
          <DialogContent className="bg-card border-border text-card-foreground sm:max-w-lg">
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  value={form.status}
                  onValueChange={(v) => setForm({ ...form, status: v as Officer['status'] })}
                >
                  <SelectTrigger className="bg-input border-border text-foreground">
                    <SelectValue />
                  </SelectTrigger>
                    ...
                    <div className="flex items-center justify-end gap-1">
                      ...
                      >
                        ...
                        <span className="sr-only">
                          Edit {officer.first_name} {officer.last_name}
                        </span>
                      </Button>
                      <Button
                        variant="ghost"
                      ...
                      >
                        ...
                        <span className="sr-only">
                          Delete {officer.first_name} {officer.last_name}
                        </span>
                      </Button>
                    </div>
                  </TableCell>
