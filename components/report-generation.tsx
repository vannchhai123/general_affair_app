...
export function ReportGeneration() {
  ...
  const [reports, setReports] = useState<GeneratedReport[]>([
    {
      ...
      dateRange: 'Feb 1-20, 2026',
      recordCount: 156,
    },
    {
      id: 'RPT-002',
      title: 'Officer Status Summary',
      type: 'officer',
      generatedAt: '2026-02-18 10:15',
      dateRange: 'Feb 2026',
      recordCount: 8,
    },
    {
      id: 'RPT-003',
      title: 'Invitation Summary Report',
      type: 'invitation',
      generatedAt: '2026-02-15 09:00',
  ...
  async function handleGenerate() {
    ...
    const newReport: GeneratedReport = {
      ...
      recordCount:
        reportType === 'officer'
          ? initialOfficers.length
          : reportType === 'invitation'
            ? initialInvitations.length
            : initialAttendance.length,
    };
  ...
  const officersByDept = [
    {
      dept: 'Operations',
      count: initialOfficers.filter((o) => o.department === 'Operations').length,
    },
    {
      dept: 'Investigations',
      count: initialOfficers.filter((o) => o.department === 'Investigations').length,
    },
    ...
    {
      dept: 'Community',
      count: initialOfficers.filter((o) => o.department === 'Community').length,
    },
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Generate and view reports from officer, invitation, and attendance data
        </p>
      </div>
